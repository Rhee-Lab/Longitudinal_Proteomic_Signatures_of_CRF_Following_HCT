...
if ("Cross-Sectional" %in% jobs_to_run) {
  pathways_of_interest_baseline_network <- c(
    ...
    # "REGULATION OF IMMUNE SYSTEM PROCESS", v2
    # "TISSUE REMODELING", v2
    # "FATTY ACID CATABOLIC PROCESS", # v2
    "TRIGLYCERIDE METABOLIC PROCESS",
    "MULTICELLULAR ORGANISMAL LEVEL HOMEOSTASIS", # v2
    "RESPONSE TO HORMONE", # v2
    # Up
    # "AXON DEVELOPMENT", # v2
    # "PHASIC SMOOTH MUSCLE CONTRACTION", # v2
    "CELL PROJECTION ORGANIZATION", # v2
    # "GLYCEROLIPID METABOLIC PROCESS", # v2
